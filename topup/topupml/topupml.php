...
$sql = "SELECT * FROM mobilelegend";
$hasil = mysqli_query($conn, $sql);

$resi = "SS332" . 83880; // Inisialisasi
    ...
    <div class="container">
        <div class="navbar">
            <ul class="nav_link" style="list-style-type: none;">
                <li><img src="assetimg/logoss.webp" alt="logo" width="62px" height="62px"></li>
        ...
        <div class="header">
            <center>
                ...
                <img src="assetimg/Screenshot 2025-02-23 175915.png" width="10%" height="10%">
            ...
            <div class="card">
                ...
                <div class="card-informasi-akun">
                    <div class="img-informasi-akun">
                        <img src="assetimg/Screenshot 2025-02-23 183355.png" width="100px" height="140px">
                    </div>
                ...
                if ($pembayaran == "Qris") {
                    ...
                    <div class="card-qris">
                        ...
                        <img src="assetimg/Screenshot 2025-02-24 163735.png" width="10%" height="10%">
                ...
                elseif($pembayaran == "Gopay" or $pembayaran == "Ovo" or $pembayaran == "Dana")  {
                    ?>
                        ...
                        <a href="topupml.html"><button name=<?php $start?> value=1> <p>Klik Disini Untuk Melakukan Pembayaran</p></button></a>
                ...
                elseif($pembayaran == "TransferBank")  {
                   ...
                   <a href="topupml.html"><button name="button-tb" value=1> <p>Klik Disini Untuk Konfirmasi Pemesanan</p></button></a>
...
<?php
$query_sql = "INSERT INTO mobilelegend (id, id_server, nominal, pembayaran, resi, jumlah, totalHarga)
                  VALUES ('$id', '$id_server', '$nominal', '$pembayaran', '$resi', '$jumlah', '$harga_total')";
